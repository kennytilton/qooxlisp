...
(define-project :name :cl-json_0.4.0
  :modules (list (make-instance 'module :name "src/package.lisp")
                 (make-instance 'module :name "src/common.lisp")
                 (make-instance 'module :name "src/objects.lisp")
                 (make-instance 'module :name "src/camel-case.lisp")
                 (make-instance 'module :name "src/decoder.lisp")
                 (make-instance 'module :name "src/encoder.lisp")
                 (make-instance 'module :name "src/utils.lisp")
                 (make-instance 'module :name "src/json-rpc.lisp"))
  :projects nil
  :libraries nil
