...
(define-project :name :cells-qx
  :modules (list (make-instance 'module :name "qx-package.lisp")
                 (make-instance 'module :name "qx-utils.lisp")
                 (make-instance 'module :name "cells-qx.lisp")
                 (make-instance 'module :name "class.lisp"))
  :projects (list (make-instance 'project-module :name
                                 "C:/0Algebra/Cells/cells"
                                 :show-modules nil)
                  (make-instance 'project-module :name
                                 "C:/cl-json/cl-json" :show-modules
                                 nil))
  :libraries nil
